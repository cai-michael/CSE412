...
queries = {
    ...
    "pollutantByTimeFrame": pollutantByTimeFrame,
    "pollutantByTimeFrameAndState": pollutantByTimeFrameAndState,
    "pollutantByTimeFrameAndCounty": pollutantByTimeFrameAndCounty,
